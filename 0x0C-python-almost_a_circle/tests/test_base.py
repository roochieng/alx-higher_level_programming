...
class TestBase(unittest.TestCase):
    ...
    def test_string_id(self):
        base_instance = Base('Python')
        self.assertEqual(base_instance.id, 'Python')
        base_instance = Base('cool')
        self.assertEqual(base_instance.id, 'cool')
